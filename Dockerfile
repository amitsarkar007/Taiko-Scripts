...
# Install required dependencies for Debian and Chromium
RUN apt-get update && \
    ...
    ca-certificates fonts-liberation libappindicator1 libnss3 lsb-release xdg-utils wget git nodejs npm \
